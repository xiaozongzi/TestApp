...
public class SwitchButton extends LinearLayout {
	...
	private void init() {
		setBackgroundResource(R.drawable.navigation_background);
		...
		maskImage.setImageResource(R.drawable.navigation_package);
		addView(maskImage);
	}
	...
	private void changeOpenStatusWithAnim(boolean open) {
		if (open) {
            ...
            maskImage.setImageResource(R.drawable.navigation_party);
		} else {
			// 右到左
            ...
            maskImage.setImageResource(R.drawable.navigation_scenic);
		}
	}
